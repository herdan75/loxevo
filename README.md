...
> **Status: Version 1.0.9 / getestete lauffähige Version**
>
...
Für die Fehlersuche kann unter `Konfiguration -> Alexa-Geräte` das `Alexa-Bridge Debug-Protokoll` aktiviert werden. Dann protokolliert LoxEvo einzelne Alexa/Hue-Abfragen und Antworten. Im Normalbetrieb sollte die Option deaktiviert bleiben, damit das Protokoll übersichtlich bleibt.
